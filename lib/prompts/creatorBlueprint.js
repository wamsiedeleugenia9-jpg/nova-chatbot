...
function sectionSummaryPrompt({ atelier, answers, currentSummary, adjustment }) {
  ...
  return {
    system: `Ești facilitatorul Creator Blueprint EWA. ${TONE} ${SUMMARY_DISCIPLINE} ${atelier.summaryInstruction} Returnează strict JSON valid cu forma {"summary":"...","keyElements":["..."]}.`,
