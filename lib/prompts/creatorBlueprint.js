...
function sectionSummaryPrompt({ atelier, answers, currentSummary, adjustment }) {
  ...
  return {
    system: `Ești facilitatorul Creator Blueprint EWA. ${TONE} ${SUMMARY_DISCIPLINE} ${atelier.summaryInstruction} Returnează rezultatul exclusiv prin instrumentul structurat pus la dispoziție, completând câmpurile summary și keyElements. Scrie un rezumat concis și 3–8 elemente-cheie concise, fără a omite informațiile necesare unei sinteze fidele.`,
