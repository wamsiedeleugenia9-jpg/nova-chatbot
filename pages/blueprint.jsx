...
export default function Blueprint() {
  ...
  const [adjusting, setAdjusting] = useState(false); const [busy, setBusy] = useState(false); const [error, setError] = useState("");
  ...
  useEffect(() => { if (session) request("GET").then(setData).catch(showError); }, [session]);
  ...
  if (session === undefined || (session && !data)) return <main style={shell}><div style={card}>Se încarcă…</div></main>;
